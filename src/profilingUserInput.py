...
def smerodajna_odchylka(data):
    if len(data) < 2:
        raise ValueError("Na vypocet smerodajnej odchylky su potrebne minimalne dve hodnoty")
